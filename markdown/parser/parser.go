...
const (
	...
	Docuowl                                       // Custom support to Docuowl components
	Emoji                                         // Process Emoji blocks
	CommonExtensions       Extensions = NoIntraEmphasis | Tables | FencedCode |
		Autolink | Strikethrough | SpaceHeadings | HeadingIDs |
		BackslashLineBreak | DefinitionLists | MathJax | Docuowl | Emoji
)
...
func NewWithExtensions(extension Extensions) *Parser {
	...
	if p.extensions&Emoji != 0 {
		p.inlineCallback[':'] = maybeEmoji
	}
